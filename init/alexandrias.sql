...
CREATE TABLE "Order_Document" (
  ...
  "max_pick_up_date" DATE NOT NULL,
...
CREATE TABLE "Like" (
  "user_id" INTEGER NOT NULL,
  "liked_review_id" INTEGER NOT NULL
);
...
ALTER TABLE "Like" ADD CONSTRAINT "like_user_id_foreign" FOREIGN KEY ("user_id") REFERENCES "User" ("id");

ALTER TABLE "Like" ADD CONSTRAINT "like_liked_revieew_id_foreign" FOREIGN KEY ("liked_review_id") REFERENCES "Review" ("id");
